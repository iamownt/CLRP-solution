...
def main():
    ...
    config = generate_config('ro', './Qymodels/roberta_large_pretrain.pt', './Qymodels/roberta_2/', 'custom', '2', "cls")
    config["finetune_long"] = finetune_long
    losses = train_ft(config, resume_from_fold=0)
